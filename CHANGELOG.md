...
### Fixed
- Fix cursor not appearing in preview pane (confirmed on Claude Code v2.1.168 which no longer renders reverse-video cursor)
...
### Changed
- Update tmux-claude-state from 0.4.0 to 0.4.1
